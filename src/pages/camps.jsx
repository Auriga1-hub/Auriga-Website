  ...
  return (
    <>
      <SEOHead
        ...
        description="Join Auriga FC's summer soccer camp for kids ages 4–13. A full week of soccer, multi-sport activities, and fun in Mississauga and Brampton. Register now!"
        keywords="summer soccer camp mississauga, kids summer camp brampton, soccer day camp, youth soccer camp GTA, kids sports camp ontario"
      />
      <StructuredData data={[
        buildBreadcrumbSchema([{ name: "Home", path: "/" }, { name: "Camps", path: "/programs/camps" }, { name: "Summer Camp", path: "/programs/camps" }]),
        buildEventSchema({ name: "Auriga FC Summer Soccer Camp", description: "Week-long summer soccer and multi-sport camp for ages 4-13 in Mississauga and Brampton.", startDate: "2026-07-06", endDate: "2026-08-28", locationName: "Mississauga, Ontario" })
      ]} />
      ...
      <div className="camps-hero">
        ...
        <div className="camps-hero-container">
          <h1 className="camps-hero-title">Summer Camp</h1>
          <p className="camps-hero-text">
            Join our engaging and high-energy camps designed to develop football skills
            while prioritizing fun, teamwork, and building fond memories.
          </p>
          <div className="camps-hero-meta">
            <span>🏕️ Summer &amp; March Break</span>
            <span>⚽ Ages 4–13</span>
        ...
        <div className="camps-container">
          <div className="camps-section-box">
            <div className="camps-section-heading">
              <span className="camps-label">Year-Round Fun</span>
              <h2 className="camps-section-title">Our Summer Camps</h2>
            </div>
            <div className="camps-intro-text">
              <p>
                Auriga Football Club offers a variety of camps throughout the year to keep
                players active and engaged.
              </p>
              <p>
                Whether it's March Break, PA Days, or Summer Vacation, we provide an exciting
                environment focused on skill-building and multi-sport activities.
              </p>
      ...
      <section className="camps-activities-section">
        <div className="camps-container">
          <div className="camps-section-box">
            <div className="camps-section-heading">
              <span className="camps-label">Summer Camp</span>
      ...
      <section className="camps-cta-section">
        <div className="camps-container">
          <div className="camps-cta">
            ...
            <p>Secure your spot in our upcoming camps and give your child a week of sports, fun, and new friendships.</p>
            <Link to="/contact" className="camps-cta-btn">Register Now</Link>
          </div>
        </div>
      </section>
