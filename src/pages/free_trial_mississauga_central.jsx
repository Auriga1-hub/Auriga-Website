...
function TrialMississaugaCentral() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!selectedDate) {
      trackFormError({
        formName: "free_trial",
        formLocation: "mississauga_central",
  ...
  return (
    <>
      <SEOHead
        title="Free Soccer Trial Mississauga Central | Book Now | Auriga FC"
        description="Book a free soccer trial session at our Mississauga Central location. Experience Auriga FC's professional youth coaching firsthand. Ages 4–13. Limited spots available."
        keywords="free soccer trial mississauga, try soccer free, kids soccer trial central mississauga, free youth soccer session, auriga fc trial"
      />
            ...
            {submitted ? (
              ...
              <>
                <div className="trial-form-header">
                  ...
                  <div style={{ background: "rgba(16, 185, 129, 0.1)", border: "1px solid rgba(16, 185, 129, 0.3)", padding: "12px 20px", borderRadius: "10px", marginTop: "16px", display: "inline-block" }}>
                    <span style={{ color: "#10b981", fontWeight: "800", display: "flex", alignItems: "center", gap: "8px", fontSize: "14px", textTransform: "uppercase", letterSpacing: "1px" }}>
                      🗓️ Runs strictly on Tuesdays and Thursdays
                    </span>
                  </div>
                </div>
                ...
                <form
                  ...
                  data-analytics-location="mississauga_central"
                ...
                >
                  ...
                  <div className="trial-fieldset">
                    ...
                    <div className="form-row">
                      <div className="form-group">
                        <label>Preferred Date (Tuesdays and Thursdays Only) <span className="req">*</span></label>
                        <DatePicker
                          selected={selectedDate}
                          onChange={(date) => setSelectedDate(date)}
                          filterDate={(date) => date.getDay() === 2 || date.getDay() === 4}
                          placeholderText="Select a Tuesday or Thursday"
...
export default TrialMississaugaCentral;
