...
function TrialMississaugaWest() {
  ...
  const handleSubmit = async (e) => {
    ...
    const templateParams = {
      ...
      subject: "Free Trial Registration - Mississauga West",
    ...
    <>
      ...
      <div className="trial-hero">
        ...
        <div className="trial-hero-container">
          <h1 className="trial-hero-title">Mississauga West Free Trial</h1>
              ...
              <>
                <div className="trial-form-header">
                  ...
                  <p className="trial-notice">
                    Free trial availability at our Mississauga West location is currently limited.
